...
function LearningView({
  ...
  return (
    <div className="learn-refresh-page learn-refresh-page--assessment">
        ...
        <div className="learn-refresh-topbar-inner">
          ...
          <div className="learn-refresh-progress">
            <p className="learn-refresh-progress-main">
              <span>{progressCurrent}</span> / {totalCount}
            </p>
      ...
      <main ref={mainRef} className={`learn-refresh-main ${mode === 'learn' ? 'learn-refresh-main--study' : 'learn-refresh-main--assessment'}`}>
        {mode === 'learn' ? (
          <div className="learn-refresh-study-layout">
            <section className="learn-refresh-study-workspace" aria-label="单词学习">
              <div className="learn-refresh-goal-strip">
